...
namespace Geometry
{
    public static class HexagonInSpaceGeometryExtensions
    {
        ...
        public static MeshData GetMeshData(this HexagonInSpace hexagonInSpace)
        {
            ...
            for (int cornerNumber = 0; cornerNumber < 6; ++cornerNumber)
            {
                ...
                vertices[vertexNumber] = hexagonInSpace.GetCornerLocalPosition(cornerNumber);
